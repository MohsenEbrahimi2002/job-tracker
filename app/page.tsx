      ...
      <main className="flex-1">
        ...
        <section className="container mx-auto px-4 py-32">
          <div className="mx-auto max-w-4xl text-center">
            <h1 className="text-black mb-6 text-6xl font-bold leading-18">
          ...
          <div className="flex flex-col items-center gap-4">
            <Link href="/signup">
              <Button>
                Start for free
                <ArrowRight className="w-4 h-4 group-hover:translate-x-1 duration-300 transition-transform"></ArrowRight>
              </Button>
            </Link>
