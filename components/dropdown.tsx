...
function DropDownMenu({ name, email }: DropDownMenuProp) {
  ...
  return (
    <div className="absolute flex p-2 z-50 bg-white flex-col justify-between right-0 top-16 w-56 shadow-lg border border-slate-800/10 h-36 rounded-md text-black">
